...
export default function HardwareAdminPage() {
      ...
      pipeTypes:
        form.hasPipeTypes === "yes"
          ? form.pipeTypes
              ...
              .filter(Boolean)
          : [],
      priceType: form.priceType, // now always "unit" or "kg"
    };
  ...
  const handleEdit = (item: any) => {
    ...
    setForm({
      ...
      // normalize "weight" (old data) to "kg"
      priceType: item.priceType === "weight" ? "kg" : item.priceType || "unit",
    });
  };
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              ...
              >
                ...
                <option value="ft">Price Per Ft</option>
              </select>
              ...
              {form.hasPipeTypes === "yes" ? (
                <>
                  ...
                  <input
                    className="bg-[var(--color-fieldBg)] text-white px-3 py-2 rounded border border-[var(--color-IconBg)] focus:outline-none focus:border-[var(--color-iconColor)] col-span-2"
                    placeholder='Square Sizes (comma separated, e.g. 1/2" x 1")'
...
/* Pagination & Item list section (unchanged) */
